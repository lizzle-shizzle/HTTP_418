...
\begin{itemize}
	...
	\item Service Contract
	\begin{figure}
		\includegraphics[scale=0.5]{ServiceContracts/class__ViewWorkerYield.png}
...
\begin{itemize}
	...
	\item Service Contract
	\begin{figure}
		\includegraphics[scale=0.5]{ServiceContracts/class__updateWorkerYield.png}
...
\begin{itemize}
	...
	\item Service Contract
	\begin{figure}
		\includegraphics[scale=0.5]{ServiceContracts/class__ViewForemanOrchardAllocation.jpg}
...
\begin{itemize}
	...
	\item Service Contract
	\begin{figure}
		\includegraphics[scale=0.5]{ServiceContracts/class__AssignWorkerToForeman.png}
		\caption{Assign Worker to Foreman}
	\end{figure}
	\begin{figure}
		\includegraphics[scale=0.5]{ServiceContracts/class__ReassignWorkerToForeman.png}
...
\begin{itemize}
	...
	\item Service Contract
	\begin{figure}
		\includegraphics[scale=0.5]{ServiceContracts/class__ViewWorkerForemanAssignment.jpg}
...
\chapter{Use Case Functionality} % Use case diagrams
	...
	\section{View Worker Yield}
	\begin{figure}
		\includegraphics[scale=0.5]{UseCaseDiagrams/uc__ViewWorkerYield.png}
		\caption{View Worker Performance}
	\end{figure}
	
	\section{Update Worker Yield}
	\begin{figure}
		\includegraphics[scale=0.5]{UseCaseDiagrams/uc__UpdateWorkerYield.png}
		\caption{Update Worker Performance}
	\end{figure}
	...
	\end{figure}
	\begin{figure}
		\includegraphics[scale=0.5]{UseCaseDiagrams/uc__ReassignWorkerToForeman.png}
	...
	\section{Generate Statistical Report Regarding Time Taken to Yield Specific Crops}
	\begin{figure}
		\includegraphics[scale=0.5]{UseCaseDiagrams/uc__GenerateStatisticalReportRegardingTimeTakenToYieldSpecificCrops.png}
		\caption{Generate Statistical Report Regarding Time Taken to Yield Specific Crops}
	\end{figure}
...
\begin{figure}
	\includegraphics[scale=0.5]{DomainModel/Domain_Model.jpg}
	\caption{Domain Model for our system}
\end{figure}
