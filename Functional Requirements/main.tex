...
\begin{itemize}
	...
	\item Service Contract
	\begin{figure}
		\includegraphics[scale=0.5]{ServiceContracts/class__ViewWorkeYield.png}
...
\chapter{Use Case Functionality} % Use case diagrams
	...
	\end{figure}
	\begin{figure}
		\includegraphics[scale=0.5]{UseCaseDiagrams/uc__AssignWorkerToForeman.jpg}
		\caption{Assign a Worker to a Foreman}
	\end{figure}
	\begin{figure}
		\includegraphics[scale=0.5]{UseCaseDiagrams/uc__ReassignWorkerToForeman.jpg}
...
\begin{figure}
	\includegrapics[scale=0.5]{ActivityDiagrams/act__Activity_Diagrams__AssignWorkerToForeman.png}
	\caption{Assign a Worker to a Foreman}
\end{figure}

\section{Reassign Worker To Foreman}
\begin{figure}
	\includegraphics[scale=0.5]{ActivityDiagrams.act__Activity_Diagrams__ReassignWorkerToForeman.png}
	\captioon{Reassign a Worker to a Foreman}
\end{figure}
...
\section{Generate Statistical Report Regarding Time Taken To Yield Specific Crops}
\begin{figure}
	\includegraphics[scale=0.5]{ActivityDiagrams/act__GenerateStatisticalReportRegardingTimeTakenToYieldSpecificCrops__GenerateStatisticalReportRegardingTimeTakenToYieldSpecificCrops.png}
...
\begin{figure}
	\includegraphics[scale=0.5]{DomainModel/Domain Model.jpg}
